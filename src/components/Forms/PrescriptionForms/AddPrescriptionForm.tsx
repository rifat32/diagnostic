...
useEffect(() => {
	...
	return (
		...
		<div className="col-md-12">
			...
			<>	
			{
				errors[`prescription.${index}.product_name`] ? (<div className="invalid-feedback">This field is required</div>):(<div className="valid-feedback">Looks good!</div>)
		...
		<div className="col-md-2">
				<button type="button" className="btn btn-danger" onClick={() => removePresctiptionElement(index)}>delete</button>
			</div>
				</div>
			...
			<>	
			{
				errors[`tests.${index}.name`] ? (<div className="invalid-feedback">This field is required</div>):(<div className="valid-feedback">Looks good!</div>)
		...
		<div className="col-md-2">
				<button type="button" className="btn btn-danger" onClick={() => removeTestsElement(index)}>delete</button>
			</div>
				</div>
...
<div className="text-center">
				<button className="btn btn-danger me-2" type="button" onClick={deleteTest}>-</button>
				<button className="btn btn-primary" type="button" onClick={AddTest}>+</button>
