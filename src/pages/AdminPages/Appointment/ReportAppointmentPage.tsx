...
import ReportAppointmentsPageComponent from "../../../components/PageComponent/ApponitmentPageComponent/ReportDoctorPageComponent";

const ReportAppointmentPage: React.FC = () => {
	return (
		<AdminPageComponent>
						...
						<div className="col-12">
							<div className="card">
								<div className="card-body">
									...
									<ReportAppointmentsPageComponent />
								</div>
							</div>
						</div>
					</div>
