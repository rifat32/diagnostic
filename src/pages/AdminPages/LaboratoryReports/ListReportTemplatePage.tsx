...
import ListReportTemplatePageComponent from "../../../components/PageComponent/LaboratoryTestsComponent/ListReportTemplatePageComponent";

const ListReportTemplatePage: React.FC = () => {
	return (
		<AdminPageComponent>
						...
						<div className="col-12">
							<div className="card">
								<div className="card-body">
									...
									<ListReportTemplatePageComponent />
								</div>
							</div>
						</div>
					</div>
...
export default ListReportTemplatePage;
