...
import ReportPatientPageComponent from "../../../components/PageComponent/PatientComponent/ReportPatientPageComponent";

const ReportPatientsPage: React.FC = () => {
	return (
		<AdminPageComponent>
